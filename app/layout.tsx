...
export const metadata = {
  title: "Gabriel Z. | Personal Portfolio",
  description: "Gabriel Zepeda | Web Developer",
};
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="!scroll-smooth">
      ...
      >
        <div className="bg-[#e2eefb] absolute top-[-6rem] -z-10 right-[11rem] h-[31.25rem] w-[31.25rem] rounded-full blur-[10rem] sm:w-[68.75rem]"></div>
